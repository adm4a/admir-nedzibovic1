...
Flight::route('GET /final/connection-check', function(){
    ...
    */
    ...
    Flight::json(["message" => "Connection check succeeded."]);
});
...
Flight::route('GET /final/login', function(){
    ...
    */
    $finalDao = new FinalDao();
    $data = $finalDao->login("demo.user@gmail.com", "1234");
    Flight::json($data);
});
...
Flight::route('POST /final/investor', function(){
    ...
    */
    ...
    $response = $finalDao->investor($first_name, $last_name, $email, $company, $share_class_id, $share_class_category_id, $diluted_shares);
...
Flight::route('GET /final/share_class_categories', function(){
    ...
    */
    $finalDao = new FinalDao();
    $data = $finalDao->share_class_categories();
    Flight::json($data);
});
